<div class="footer">
    <div class="footer-content">
      <div class="footer-section about">
        <h1 class="logo-text">Fancy<span>Blog</span></h1>
        <p>
          Fancy is a fictional blog conceived for the purpose
          of practice. However, Edik has a blog called pieceofadvice.org
    ...
    <div class="footer-bottom">
      <p>© Coding Poets | Designed by Edik Muliar</p>
    </div>
  </div>